...
PYHIEW_PATH = _hiew.PYHIEW_PATH # pyhiew scripts path
PYHIEW_VERSION = _hiew.PYHIEW_VERSION # pyhiew plugin version
...
def PyHiew_Main():
    ...
    if not PYHIEW_STARTUP_SCRIPT_EXECUTED:
        # Execute it the requested scope
